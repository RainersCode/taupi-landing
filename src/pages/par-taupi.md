...
- **Dienas budžets** — katru rītu Taupi pārrēķina, cik šodien vari tērēt, ņemot vērā algu, fiksētos maksājumus un mērķus.
- **Čeku skenēšana ar AI** — nofotografē čeku, un katra prece automātiski nonāk savā kategorijā. Veidots tieši Latvijas veikalu čekiem.
- **Ieskati** — finansiālās veselības vērtējums un personalizēti novērojumi par taviem paradumiem.
- **Mērķi un neto vērtība** — uzkrājumu mērķi ar reālu progresu un visa tava nauda vienā skatā.
