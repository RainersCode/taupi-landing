...
These Terms of Service ("Terms") are the agreement between **you** (the "user") and **taupi.eu** (email info@taupi.eu, the "Provider", "we", "us") when you use the Taupi mobile application and any related websites (together, the "Service").
...
When you use receipt scanning or AI insights, the relevant data is sent to an AI provider (currently **Anthropic**) to process. See the [Privacy Policy](/en/privacy-policy/) for the detailed data flow.
