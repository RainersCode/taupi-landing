...
export const strings: Record<Locale, Dict> = {
  lv: {
    ...
    "features.budget.p2": "Fiksētie maksājumi un mērķu iemaksas jau ierēķinātas",
    ...
    "features.scan.p1": "Preču līmeņa detalizācija — 23 kategorijas",
    ...
    "features.insights.p1": "Skors 0–100 par šī perioda signāliem",
    ...
    "features.goals.body": "Uzkrājumu mērķi ar reālu progresu — iemaksas vari piesaistīt īstam krājkontam, un Taupi tur līdzi tempu.",
    "features.goals.p1": "Piesaisti mērķi savam krājkontam",
    "features.goals.p2": "Redzi tempu — priekšā vai iepakaļ grafikam",
    "features.goals.p3": "Iemaksas ierēķinātas dienas budžetā",
    "features.invest.title": "Neto vērtība",
    "features.invest.body": "Visa tava nauda vienuviet — konti, investīcijas un kripto ar vērtības izmaiņām laika gaitā, ne tikai tēriņi.",
